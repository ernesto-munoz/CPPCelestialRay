...
struct TestSceneInfo {
	...
	Camera cam;
	std::function<void(HittablesList&)> create;
};
...
public :
	...
	static constexpr std::vector<kTestScenes> GetAllTestScenes() {
		return { kTestScenes_MultipleSpheres, kTestScenes_BasicScene, kTestScenes_CheckeredSpheres, kTestScenes_Earth, kTestScenes_Earth4K, kTestScenes_Quads, kTestScenes_CornellBox, kTestScenes_AssimpCubeLoader };
	}
